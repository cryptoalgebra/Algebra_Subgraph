...
export function handleSwap(event: SwapEvent): void {
 ...
 if (amount0.lt(ZERO_BD)) {
   ...
   amount0withoutFee = amount0.times(BigDecimal.fromString('1000000').minus(pool.feeZtO.toBigDecimal())).div(BigDecimal.fromString('1000000'))
   amount0Abs = amount0
 } 
 ...
 if (amount1.lt(ZERO_BD)) {
   ...
   communityFeeAmount = communityFeeAmount.times(BigDecimal.fromString("1"))  
   amount1Abs = amount1
   amount1withoutFee = amount1.times(BigDecimal.fromString('1000000').minus(pool.feeOtZ.toBigDecimal())).div(BigDecimal.fromString('1000000'))
 }
